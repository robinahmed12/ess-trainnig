...
console.log(
  hasPassword ? "Password key exists" : "Password key does not exist"
);
...
// Count how many times each element appear
...
for (let i = 0; i < numb.length; i++) {
  if (numb[i] % 2 === 0) {
    groups.even.push(numb[i])
  } else {
    groups.odd.push(numb[i])
  }
}
